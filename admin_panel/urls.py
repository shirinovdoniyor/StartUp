...
from .views import admin_dashboard, admin_users, admin_user_detail, admin_user_update, admin_workshops, \
    admin_workshop_detail, admin_workshop_delete, admin_workshop_update
